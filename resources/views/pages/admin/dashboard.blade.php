<x-layouts.app>
                ...
                <div class="flex items-center">
                    ...
                    <div class="grow ltr:ml-3 rtl:mr-3">
                        ...
                        <div class="flex items-center justify-between">
                            <h4 class="mb-0">400+</h4><span class="text-success font-medium">30.6%</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="flex items-center">
                    ...
                    <div class="grow ltr:ml-3 rtl:mr-3">
                        ...
                        <div class="flex items-center justify-between">
                            <h4 class="mb-0">520+</h4><span class="text-warning fw-medium">30.6%</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="flex items-center">
                    ...
                    <div class="grow ltr:ml-3 rtl:mr-3">
                        ...
                        <div class="flex items-center justify-between">
                            <h4 class="mb-0">800+</h4><span class="text-success fw-medium">30.6%</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="flex items-center">
                    ...
                    <div class="grow ltr:ml-3 rtl:mr-3">
                        ...
                        <div class="flex items-center justify-between">
                            <h4 class="mb-0">1,065</h4><span class="text-danger fw-medium">30.6%</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="flex items-start justify-between">
                    ...
                    </div><select class="form-select rounded-3 form-select-sm w-auto">
                        <option>Today</option>
                    ...
                    <div class="grid grid-cols-12 gap-3">
                        <div class="col-span-4">
                            <div class="text-center d-inline-block px-md-3">
                                ...
                                <h5 class="inline-flex items-center gap-1 mb-0">$20k <i
                                            class="ti ti-arrow-narrow-down text-danger-500"></i></h5>
                            </div>
                        </div>
                        <div class="col-span-4">
                            <div class="text-center d-inline-block px-md-3">
                                <p class="mb-1 text-muted">Revenue</p>
                                <h5 class="inline-flex items-center gap-1 mb-0">$16k <i
                                            class="ti ti-arrow-narrow-up text-success-500"></i></h5>
                            </div>
                        </div>
                        <div class="col-span-4">
                            <div class="text-center d-inline-block px-md-3">
            ...
            <div class="card-body !px-0 !py-2">
                <ul
                    ...
                    <li class="list-group-item">
                        <div class="flex items-center">
                            <div class="shrink-0"><img src="../assets/images/admin/img-bootstrap.svg"
                                                       alt="img" class="w-10 rounded-lg"></div>
    ...
    <div class="col-span-12 lg:col-span-7">
        <div class="card">
            <div class="card-body">
                <div class="flex items-center justify-between">
                    <h5 class="mb-0">Courses</h5><button class="btn btn-sm btn-link-primary">View
                        Report</button>
                </div>
    ...
    <div class="col-span-12 lg:col-span-4">
        <div class="card">
            <div class="card-body">
                ...
                <ul
                        class="rounded-lg *:py-4 divide-y divide-inherit border-theme-border dark:border-themedark-border">
                    <li class="list-group-item">
                        <div class="flex items-center">
    ...
    <div class="col-span-12 lg:col-span-6">
        <div class="card table-card">
            <div class="card-header">
                <div class="flex items-center justify-between">
                    <h5 class="mb-0">Activity</h5><button class="btn btn-sm btn-link-primary">View
                        All</button>
                </div>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <td>Developer</td>
                            <td class="font-semibold"><i class="fas fa-star text-warning-500"></i> 5.0
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td class="font-semibold"><i class="fas fa-star text-warning-500"></i> 4.5
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td class="font-semibold"><i class="fas fa-star text-warning-500"></i> 4.3
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td class="font-semibold"><i class="fas fa-star text-warning-500"></i> 4.9
                            </td>
                        </tr>
                        <tr>
                            <td>
    ...
    <div class="col-span-12 lg:col-span-4 md:col-span-6">
        <div class="card">
            <div class="card-body">
                <div class="flex items-center justify-between mb-3">
                    <h5 class="mb-0">Earning Courses</h5><select
    ...
    <div class="col-span-12">
        <div class="card table-card">
            <div class="card-header">
                <div class="flex items-center justify-between">
                    <h5 class="mb-0">Course States</h5><button class="btn btn-sm btn-link-primary">View
                        All</button>
                </div>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <td>Airi Satou</td>
                            <td class="font-semibold"><i class="fas fa-star text-warning-500"></i> 4.8
                            </td>
                            <td>$200</td>
                        ...
                        <tr>
                            ...
                            <td class="font-semibold"><i class="fas fa-star text-warning-500"></i> 4.4
                            </td>
                            <td>$150</td>
