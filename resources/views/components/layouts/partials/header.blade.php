        ...
        <div class="me-auto pc-mob-drp">
            <ul class="inline-flex *:min-h-header-height *:inline-flex *:items-center">
                ...
                <li class="pc-h-item pc-sidebar-popup lg:hidden"><a href="#" class="pc-head-link ltr:!ml-0 rtl:!mr-0"
                        id="mobile-collapse"><i class="ti ti-menu-2 text-2xl leading-none"></i></a></li>
                <li class="pc-h-item max-md:hidden md:inline-flex">
                    <form class="form-search relative"><i class="search-icon absolute top-[14px] left-[15px]"><svg
                                class="pc-icon w-4 h-4">
                                <use xlink:href="#custom-search-normal-1"></use>
                            </svg> </i><input type="search"
                            class="form-control px-2.5 pr-3 pl-10 w-[198px] leading-none" placeholder="Ctrl + K">
                    </form>
                </li>
            </ul>
        ...
        <div class="ms-auto">
            <ul class="inline-flex *:min-h-header-height *:inline-flex *:items-center">
                <li class="dropdown pc-h-item"><a class="pc-head-link dropdown-toggle me-0" data-pc-toggle="dropdown"
                        href="#" role="button" aria-haspopup="false" aria-expanded="false"><svg class="pc-icon">
                            <use xlink:href="#custom-sun-1"></use>
                        </svg></a>
                    <div class="dropdown-menu dropdown-menu-end pc-h-dropdown"><a href="#!" class="dropdown-item"
                            onclick="layout_change('dark')"><svg class="pc-icon w-[18px] h-[18px]">
                                <use xlink:href="#custom-moon"></use>
                            </svg> <span>Dark</span> </a><a href="#!" class="dropdown-item"
                            onclick="layout_change('light')"><svg class="pc-icon w-[18px] h-[18px]">
                                <use xlink:href="#custom-sun-1"></use>
                            </svg> <span>Light</span> </a><a href="#!" class="dropdown-item"
                            onclick="layout_change_default()"><svg class="pc-icon w-[18px] h-[18px]">
                ...
                <li class="pc-h-item"><a href="#" class="pc-head-link me-0" data-pc-toggle="offcanvas"
                        data-pc-target="#announcement" aria-controls="announcement"><svg class="pc-icon">
                ...
                <li class="dropdown pc-h-item"><a class="pc-head-link dropdown-toggle me-0" data-pc-toggle="dropdown"
                        href="#" role="button" aria-haspopup="false" aria-expanded="false"><svg class="pc-icon">
                            ...
                            class="badge bg-success-500 text-white rounded-full z-10 absolute right-0 top-0">3</span></a>
                            ...
                            <div class="card mb-2">
                                <div class="card-body">
                                    <div class="flex gap-4">
                                        <div class="shrink-0"><svg class="pc-icon text-primary w-[22px] h-[22px]">
                                                <use xlink:href="#custom-layer"></use>
                                            </svg></div>
                                        <div class="grow"><span class="float-end text-sm text-muted">2 min
                                                ago</span>
                            ...
                            <div class="card mb-2">
                                <div class="card-body">
                                    <div class="flex gap-4">
                                        ...
                                        <div class="grow"><span class="float-end text-sm text-muted">1 hour
                                                ago</span>
                            ...
                            <div class="card mb-2">
                                <div class="card-body">
                                    <div class="flex gap-4">
                                        ...
                                        <div class="grow ms-3"><span class="float-end text-sm text-muted">2 hour
                                                ago</span>
                            ...
                            <div class="card mb-2">
                                <div class="card-body">
                                    <div class="flex gap-4">
                                        ...
                                        <div class="grow ms-3"><span class="float-end text-sm text-muted">12 hour
                                                ago</span>
                            ...
                            <div class="card mb-2">
                                <div class="card-body">
                                    <div class="flex gap-4">
                                        ...
                                        <div class="grow ms-3"><span class="float-end text-sm text-muted">5 hour
                                                ago</span>
                        ...
                        <div class="dropdown-body py-4 px-5">
                            <div class="profile-notification-scroll position-relative"
                                ...
                                <div class="card">
                                    <div class="card-body !py-4">
                                        <div class="flex items-center justify-between">
                                            <h5 class="mb-0 inline-flex items-center"><svg
                                                    class="pc-icon text-muted me-2 w-[22px] h-[22px]">
                                                    <use xlink:href="#custom-notification-outline"></use>
                                                </svg> Notification</h5><label
                                ...
                                <p class="text-span mb-3">Manage</p><a href="#" class="dropdown-item"><span><svg
                                            class="pc-icon text-muted me-2 inline-block">
                                            <use xlink:href="#custom-setting-outline"></use>
                                        </svg> <span>Settings</span> </span></a><a href="#"
                                    class="dropdown-item"><span><svg class="pc-icon text-muted me-2 inline-block">
                                ...
                                <hr class="border-secondary-500/10 my-4">
                                <div class="grid mb-3"><button
                                        class="btn btn-primary flex items-center justify-center"><svg
                                            class="pc-icon me-2 w-[22px] h-[22px]">
                                    ...
                                    <div class="card-body">
                                        <div
                                            ...
                                            <img src="../assets/images/user/avatar-1.jpg" alt="user-image"
                                                ...
                                                src="../assets/images/user/avatar-3.jpg" alt="user-image" class="avtar">
                                            <img src="../assets/images/user/avatar-4.jpg" alt="user-image"
                                                class="avtar"> <img src="../assets/images/user/avatar-5.jpg"
                                        ...
                                        <div class="btn btn-warning inline-flex items-center justify-center"><svg
                                                class="pc-icon me-2 w-[22px] h-[22px]">
                                                <use xlink:href="#custom-logout-1-outline"></use>
...
<div class="offcanvas pc-announcement-offcanvas offcanvas-end" tcabindex="-1" id="announcement"
    ...
    <div class="offcanvas-header">
        <h5 class="offcanvas-title" id="announcementLabel">What's new announcement?</h5><button
            data-pc-dismiss="#announcement"
            class="text-lg flex items-center justify-center rounded w-7 h-7 text-secondary-500 hover:bg-danger-500/10 hover:text-danger-500"><i
        ...
        <div class="card mb-3">
            <div class="card-body">
                <div class="items-center flex wrap gap-2 mb-3">
                    ...
                    <p class="mb-0">2 min ago</p><span class="badge bg-warning-500 p-1"></span>
                </div>
        ...
        <div class="card mb-3">
            <div class="card-body">
                <div class="items-center flex wrap gap-2 mb-3">
                    ...
                    <p class="mb-0 text-muted">2 hour ago</p><span class="badge bg-warning p-1"></span>
                </div>
        ...
        <div class="card mb-3">
            <div class="card-body">
                <div class="items-center flex wrap gap-2 mb-3">
                    ...
                    <p class="mb-0 text-muted">12 hour ago</p><span class="badge bg-warning p-1"></span>
                </div>
                <h5 class="mb-3">Featured Dashboard Template</h5>
                <p class="text-muted mb-3">Do you know Able Pro is one of the featured dashboard template selected
                    by Themeforest team.?</p><img src="../assets/images/layout/img-announcement-3.png" alt="img"
                    class="img-fluid">
            </div>
        </div>
        <div class="card mb-3">
            <div class="card-body">
                ...
                <p class="text-muted mb-3">Get the lifetime free updates once you purchase the Able Pro.</p><img
                    src="../assets/images/layout/img-announcement-4.png" alt="img" class="img-fluid">
            </div>
        </div>
    </div>
</div>